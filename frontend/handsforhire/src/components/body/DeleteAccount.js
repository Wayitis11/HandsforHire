                    ...
                    <div className="row flex-lg-nowrap">
                            ...
                            <div className="card p-3">
                                <div className="e-navlist e-navlist--active-bg">
                                    <ul className="nav d-block">
                                        ...
                                        <li className="nav-item"><a className="nav-link px-2" href><i className="fa fa-fw fa-trash mr-1" /><span>Delete Account</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="col">
                            ...
                            <div className="col">
                                ...
                                , "top" : "30%", "fontWeight" : "bold" }}>By click on delete button, you will permanently removing all your data, including hiring and favorite</Typography>
                                <Button variant="contained" style={{ "backgroundColor" : "#C71626", "color" : "#fff", "position" : "relative"
                                , "top" : "50%", "left" : "35%"  }} className="btn btn-danger button" onClick={this.deleteAccount} >Delete account</Button>
                            </div>
