...
export default class UpdateProfessionalPassword extends Component {
    ...
    UpdatePassword = (e) => {
        ...
        axios.put('https://handsforhire.herokuapp.com/api/change_password/' + localStorage.getItem('user') + '/', data, { headers: headers })
            .then((response) => {
